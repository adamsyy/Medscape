...
int check=0;
late String hospital_topost;
late String blood_topost;
late String phone_topost;

class Post_blood extends StatefulWidget {


  @override
  _Post_bloodState createState() => _Post_bloodState();
}

class _Post_bloodState extends State<Post_blood> {
  @override
                            ...
                            child: Column(
                              children: [
                                Column(
                                    ...
                                    children: [
                                      Padding(
                                        padding: EdgeInsets.fromLTRB(26, 29, 150, 4),
                                        child: Text(
                                          'Add a Blood request',
                                          style: TextStyle(
                                            fontSize: 16.0,
                                      ...
                                      Padding(
                                        ...
                                        child: TextField(
                                          onChanged: (String blood_type){
                                     blood_topost=blood_type;
                                          },
                                      ...
                                      Padding(
                                        padding: EdgeInsets.fromLTRB(20, 4, 19, 0),
                                        child: TextField(       onChanged: (String hospital){
hospital_topost=hospital;
                                        },
...
phone_topost=phone;
  ...
  dynamic fetchToknens() async {
   ...
   "blood":blood_topost,
      "hospital":hospital_topost,
      "phone":phone_topost
    };
    final url = Uri.parse(c.url.toString() + "blood/post");
    ...
    if (response.statusCode == 200) {
      setState(() {
        data = json.decode(response.body)["bloods"];
        print("///");
        print(data);
      });
